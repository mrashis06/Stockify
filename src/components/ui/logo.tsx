...
>(({ className, ...props }, ref) => {
    return (
        ...
        >
            ...
            <g transform="translate(60, 5) rotate(15 25 25)">
            ...
            <text x="118" y="45" fontSize="50" fontWeight="bold" className="logo-fill-2">ck</text>
            <text x="180" y="45" fontSize="50" fontWeight="bold" className="logo-fill-3">ify</text>
        </svg>
    );
});
